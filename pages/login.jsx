        ...
        <section className="min-h-screen mx-auto mt-20">
          <div className="lg:w-1/2 w-full mx-auto text-center md:px-16 px-0 z-0 bg-slate-300 shadow-md shadow-indigo-600 rounded-md">
            <div className="w-full py-6 z-20">
              <h1 className='text-4xl font-black text-indigo-500'>Sing In</h1>
              ...
              <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                ...
                <div className="px-4 pb-2 pt-4">
                  <button className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none font-bold text-white">Login</button>
                </div>
