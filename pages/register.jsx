...
const register = () => {
  ...
  return (
    <Layout>
      <div>
        <section className="min-h-screen mx-auto mt-20">
          <div className="lg:w-1/2 w-full mx-auto text-center md:px-16 px-0 z-0 bg-slate-300 shadow-md shadow-indigo-600 rounded-md">
            <div className="w-full py-6 z-20">
              <h1 className='text-4xl font-black text-indigo-500'>Register</h1>
              ...
              <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                <div className="pb-2 pt-4">
                  <input onChange={handleChange} type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm" />
                </div>
                <div className="pb-2 pt-4">
                  <input onChange={handleChange} className="block w-full p-4 text-lg rounded-sm" type="password" name="password" id="password" placeholder="Password" />
                </div>
                <div className="text-right text-gray-400 hover:underline hover:text-gray-100">
                  <a href="#">Forgot your password?</a>
                </div>
                <div className="px-4 pb-2 pt-4">
                  <button className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none font-bold text-white">Register</button>
                </div>
